const ALL_TOOLS = [
  ...
  { name: "TrustSignal", desc: "Domain security score", url: "https://trustsignal-delta.vercel.app", live: true },
  { name: "BreachCost", desc: "Data breach cost estimator", url: "https://breachcost.vercel.app", live: true },
  { name: "RoleForge", desc: "AI org role generator", url: null, live: false },
];

const CURRENT = "OpsIntel";
  ...
  return (
    <footer className="border-t border-border px-4 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-10 text-center text-xs text-muted/50">OpsIntel · Built by <a href="https://arknet.digital" target="_blank" rel="noopener noreferrer" className="hover:text-muted transition-colors">ArkNet Digital</a></p>
      </div>
    </footer>
  );
}
